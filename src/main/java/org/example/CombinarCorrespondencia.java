...
public class CombinarCorrespondencia {
    ...
    public static Map<String, Cliente> cargarClientes() throws ArchivosFaltantesException {
        ...
        try {
            ...
            BufferedReader br = new BufferedReader(new FileReader("src/main/resources/Clientes.csv"));
            String line;
            ...
            throw new ArchivosFaltantesException("Falta un archivo.");
        }
        return clientes;
    }
